Language: [EN](README_EN.md) | ES

<div style="display: flex; align-items: center; flex-direction: column;">

# Marah
<img src="assets/icon.png" alt="Marah" style="width: 100px;">
</div>

---
Plantilla para proyectos de _Metodologías de Diseño y Programación_, con visualizador interactivo basado en React y Scala.
