...
En la carpeta [src/main/scala/model](src/main/scala/model) se encuentran las clases necesarias para
implementar el juego.

Con todas las estructuras descritas anteriormente, debe llegar al siguiente estado en el visualizador.
...
- No deben haber acciones disponibles. Ninguna carta es clickeable y no hay acciones en el menu inferior.
...
Para ello, implemente la clase [GameController](/src/main/scala/controller/GameController.scala) con el tipo de juego que se corresponda.